...
<cfoutput><title>Get Well Gifts | #application.seoPageTitle#</title></cfoutput>
...
<div id="about">
  ...
  <div class="clr">
    <h6>
      <span>You know what your loved one needs to get well soon and Hospital Gift Shop can help find it.</span> Search
      our Get Well gifts to find the perfect flowers, balloons and more.
    </h6>
  </div>
...
<cfoutput query="Gifts">
  ...
  <span>
  <em><img alt="" style="height: 12px;" src="assets/images/sameday-arrow.gif"/>#Gifts.DeliveryOption# </em>
    </span>
    </div>
        <a href="productdetail.cfm?id=#Gifts.ID#">
