...
<cfoutput><title>#application.seoPageTitle#</title></cfoutput>
...
<div id="home">
  <div class="clr">
    <div class="top-bg">
      <div class="top-left">
        <!-- Data Output -->
        <!-- This is where the name and position are ouput. -->
        <div class="tag">SAME DAY<span>delivery on 100+ items</span></div>
        <div class="sub-tag">Order Online</div>
      </div>
    </div>
  </div>
  <div class="clr">
  ...
  <div class="clr pat">
    <p>New <span>baby gifts</span> and <span>fresh flowers</span> for mom, dad and baby.</br>
      Share on Facebook for <span>free hospital flower delivery</span> for you and your friends.</p>
  </div>
  <div class="clr">
  ...
  <div class="clr">
    ...
    <div class="special">
      <h5>Has the patient left the hospital early?</h5>No problem. Our service includes re-routing of a fresh
      arrangement or gift basket wherever your recipient is located.
