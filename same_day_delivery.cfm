...
<cfoutput><title>Same Day Delivery | #application.seoPageTitle#</title></cfoutput>
...
<div id="about">
  <div class="clr">
    <div class="top-bg1">
      <div class="top-left">
        <div><h1>Same Day Delivery</h1></div>
      </div>
    </div>
    <div class="clr">
  ...
  <div class="clr">
    <h6>
      Need to get a gift to your loved one in the hospital today? Any of our <span>Same Day items</span> in this
      category would be a great choice! From flowers, to balloons to yummy chocolate gift baskets! <br/> <span>Our gifts are sure to bring a smile to your loved one's face!</span>
    </h6>
  </div>
