...
<tr>
    ...
    <td width="12" height="12"  bgcolor="#999999" title="#999999" onclick = "put_back('#000000');"><img border="0" src="spacer.gif" width="12" height="12" alt="Lt Grey"></td>
					...
					for (a=1;a<=3;a++){					
						...
						for (b=1;b<=6;b++){							
							...
							colour = d[a] + d[b] + d[c];
							 ...
							 document.write("<td width='12' height='12' onclick=\"put_back('#"+colour+"')\" bgcolor=\"#"+colour+"\" title=\"#"+colour+"\"><img border='0' src=\"spacer.gif\" width=12 height=12></td>\n");
						    if (a==3 && b==6){
							document.write("</tr>\n<tr>\n");
							}
