...
<div style="width: 600px; margin: auto;"><h2>Select an Image</h2></div>
  <cfif NOT dir IS "\">
    <cfoutput></cfoutput>
  </cfif>
...
<!---Display the list of files--->
	...
	<cfif thetype IS 'Image'>
		...
		<cfset choiceURL = "#request.absolutepath#images/#pathto##name#">
        <cfset choiceURL = replace(choiceURL, "//", "/", "ALL")>
        <a href = "##" onclick="getImage(#CKEditorFuncNum#, '#ChoiceURL#');">
		<div align="center" style="height: 150px; overflow: hidden; width: 200px">
