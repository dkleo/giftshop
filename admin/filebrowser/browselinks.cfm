...
{
	var myPath  = '#request.absolutepath#'+template+'?Page=docs/'+fileUrl ;
...
function getDoc_alias(template,fileUrl )
{
	if(template == 'index.cfm') {
		var myPath  = '#request.absolutepath#'+fileUrl ;
	}
	else {
		var myPath  = '#request.absolutepath#'+template+'/'+fileUrl ;
	}
...
{
	var myPath  = '#request.absolutepath#'+template+'?action=viewcategory&category='+fileUrl ;
	var funcNum = '#CKEditorFuncNum#' ;
	window.opener.CKEDITOR.tools.callFunction( funcNum, myPath ) ;
	window.top.close() ;
	window.top.opener.focus() ;
...
{
	var myPath  = '#request.absolutepath#'+template+'?action='+fileUrl ;
	var funcNum = '#CKEditorFuncNum#' ;	
	window.opener.CKEDITOR.tools.callFunction( funcNum, myPath ) ;
	window.top.close() ;
	window.top.opener.focus() ;
