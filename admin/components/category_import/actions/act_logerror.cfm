...
<table cellpadding="5" cellspacing="1" border="0" width="100%">
	...
	<cfloop list="#infoList#" index="errorItem">
        ...
        <cfif errorItem IS 'Message'>
        	<cfset errorbrief = "CATEGORY IMPORT ERROR: #replace(cfcatch.message, '#request.bslash#', '#request.bslash##request.bslash#', 'ALL')#  Error Occurred on line #cfcatch.Tagcontext[1].LINE# in #replace(cfcatch.Tagcontext[1].template, '#request.bslash#', '#request.bslash##request.bslash#', 'ALL')# #extrainfo#">
		</cfif>      
