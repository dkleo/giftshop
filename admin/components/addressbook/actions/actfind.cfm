...
<p align="center"><font color="#FF0000"><b>SEARCH RESULTS</b></font></p>
<table border="0" cellpadding="2" width="100%" cellspacing="0">
<cfoutput query="qrycontacts">
<cfif CompanyName CONTAINS #form.SearchBox# OR FirstName CONTAINS #form.SearchBox# OR LastName CONTAINS #form.SearchBox#> 
 	<tr>
	  <td width="100%" colspan="3" bgcolor="##99CCFF"><a href="index.cfm?action=Add"><img border="0" src="icons/icon_folder_new.gif" width="18" height="16" alt="New Contact"></a>
		<b><a href="index.cfm?Action=Edit&ContactID=#ContactID#"><img border="0" src="icons/icon_pencil.gif" alt="Edit this Contact" width="15" height="15"></a>
		<a href="index.cfm?Action=Delete&ContactID=#ContactID#"><img border="0" src="icons/icon_trashcan.gif" alt="Delete Contact" width="16" height="15"></a>
