...
function getAffiliate ( idnumber, fname, ffield )
{
	window.top.opener.SetId( idnumber, fname, ffield ) ;
	window.top.close() ;
...
<cfparam name = "ffield" default="refid">
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr>
	...
	<form name="Displayoptions" method="POST" Action="index.cfm?action=select">
...
<!---calculations for paginating--->
   ...
   <CFELSE>
	...
	<div align="center"> <cfoutput> 
          <!---Display the page numbers--->
            <form name = "PageSelect" method="Post" Action="index.cfm?action=select">
  ...
  <tr>
    <td colspan="2" valign="top">
		<form id="form1" name="form1" method="post" action="index.cfm?action=select">
        Sorty By: 
...
<table width="100%" border="0" cellspacing="0" cellpadding="6">
  <tr>
    <td width="25%" bgcolor="#0066CC"><strong><font color="#FFFFFF">Name</font></strong></td>
    <td width="25%" bgcolor="#0066CC"><strong><font color="#FFFFFF">Email Address </font></strong></td>
...
<cfloop query = "qryAffiliates" startrow="#start#" endrow="#end#">
  <tr class="selecttr" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
    ...
    <td><cfoutput>#AffiliateID#</cfoutput></td>
    <td><div align="center"><cfoutput>#groupid#</cfoutput></div></td>
    <td><div align="center">
      <div align="center"><cfoutput>
        <div align="center">
        <a href="##" onclick="getAffiliate('#affiliateid#', '#fname#', '#ffield#')">Select</a></cfoutput></div>
      </div></td>
  </tr>
</cfloop>
</form>
