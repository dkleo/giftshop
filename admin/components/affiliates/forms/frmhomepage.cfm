...
<h2>Affiliate Home Page</h2>
<cfif NOT fileexists('#request.CatalogPath#affiliates#request.bslash#pages#request.bslash#homepage.cfm')>
	<cffile action = "write" file = "#request.CatalogPath#affiliates#request.bslash#pages#request.bslash#homepage.cfm" output=" ">
</cfif>

<cffile action = "read"
file = "#request.CatalogPath#affiliates#request.bslash#pages#request.bslash#homepage.cfm" 
variable = "PageContent">

<cfoutput>
<form id="theForm" method="post" action="index.cfm?action=updatehomepage">
