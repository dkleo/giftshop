...
<h2>Mixed Shipping Table</h2>
<p><a href="doshipping.cfm?action=EditShippingTypes&amp;ReturnPath=EditFive">Add/Remove Shipping 
  Types</a></p>
...
<input type="text" name="Amount" size="9">
  ...
  <div align="center"> 
  	<input type="hidden" name="action" value="AddFive">
    ...
    <center>
      <table border="1" cellpadding="2" cellspacing="0" width="99%" bordercolorlight="#808080" bordercolordark="#808080" bordercolor="#0066FF" style="border-collapse: collapse">
        ...
        <cfoutput query = "qryTableFive"> 
          <tr> 
            <td width="38%"> 
              <a href="doshipping.cfm?action=EditAFive&ShippingID=#ShippingID#"> 
              #Shippingtype#</a></td>
			...
			<cfif request.EnableEuro IS 'Yes'>
				#LSEuroCurrencyformat(Amount, "Local")#<cfelse>#LSCurrencyformat(Amount, "Local")#</cfif>
			</cfif>
			<cfif AmountType IS 'Percent'>
				#Amount#%
			</cfif>
			</td>
            <td width="10%" align="center"><a href="doshipping.cfm?action=DeleteFive&ShippingID=#ShippingID#">Delete</a></td>
          </tr>
        </cfoutput> 
      </table>
    </center>
