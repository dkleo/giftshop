...
<table width="500" border="1" align="center" cellpadding="4" cellspacing="0">
  <tr align="center" bgcolor="#333366">
    <td height="25" colspan="2" class="headerWhite"><span class="style1">Request an Identification Number (Meter Code) From Fedex</span></td>
  </tr>
  <tr align="center" bgcolor="#EEEEEE">
    <td colspan="2" class="bodyText">In order to perform many requests to the
      ...
      Server. Filling out the form below will perform this function for you and
      return to you your Fedex Identification Number for future use.<br>
      <strong><font color="#FF0000">* Note enter the same information below that
      you have noted on your acocunt with fedex as your account billing information</font></strong></td>
  </tr>
  <cfform action="doshipping.cfm?action=fedexregister" method="post">
  <tr>
