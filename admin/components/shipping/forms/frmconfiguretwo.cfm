...
<h2>Percentage-Based Shipping Table</h2>
<p><a href="doshipping.cfm?action=EditShippingTypes&ReturnPath=EditTwo">Add/Remove Shipping 
  Types</a></p>
...
<center>
      <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="75%" id="AutoNumber1">
        <tr> 
          ...
          <td width="25%" align="center" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4" bordercolor="#000000" bgcolor="#000080"> 
            <font color="#FFFFFF">Percentage</font></td>
        </tr>
        <tr> 
...
<input type="text" name="Amount" size="9">
  ...
  <div align="center"> 
  	<input type="hidden" name="action" value="AddTwo">
    ...
    <center>
      <table border="1" cellpadding="2" cellspacing="0" width="99%" bordercolorlight="#808080" bordercolordark="#808080" bordercolor="#0066FF" style="border-collapse: collapse">
        ...
        <cfoutput query = "qryTableTwo"> 
          <tr> 
            <td width="38%"> 
              <a href="doshipping.cfm?action=EditATwo&ShippingID=#ShippingID#"> 
              #Shippingtype#</a></td>
            ...
            <td width="32%" align="center"><cfset TheAmount = Amount * 100>#TheAmount#%</td>
            <td width="10%" align="center"><a href="doshipping.cfm?action=DeleteTwo&ShippingID=#ShippingID#">Delete</a></td>
          </tr>
        </cfoutput> 
      </table>
    </center>
