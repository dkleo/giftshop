...
<form name="globe" Method = "POST" action="doshipping.cfm">
  <p><strong>Surcharges</strong> <cfoutput><a href = "#request.AdminPath#helpdocs/shipping_surcharges.cfm" onclick="NewWindow(this.href,'Help','375','450','yes');return false;")><b><img src = "#request.AdminPath#images/help.gif" border="0" /></b></a></cfoutput></p>
...
<font color="#FF0000"><b><h2>Warning!</h2>  You do not have any states/provinces and/or countries setup to ship to.  If you do not have them setup, your customers will be given a text box and they will have to type their state/province and country into the box.  If you specify tax information here, and they mistype the information, they will not be charged a sales tax.  If you plan on charging taxes, then you should setup the areas you ship to <a href="../components/shipping/doshipping.cfm?action=shippingareas">here</a>.</b></font>
    ...
    <br>
    Other: 
    <input type = "Text" Name= "OtherRegion" size="35">
    <br>
    ...
    <input name="SurCharge" type="text" id="SurChargeRate" value="0.00" size="7" maxlength="5">
    <input type="hidden" value="addSurCharge" name="action">
...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr bgcolor="#003399"> 
    ...
    <td width="35%"><div align="center"><strong><font color="#FFFFFF">Country</font></strong></div></td>
    <td width="23%"><div align="center"><strong><font color="#FFFFFF">Amount to Add</font></strong></div></td>
  ...
  <cfoutput query = "qrySurcharges"> 
    <tr> 
      ...
      <td><div align="center">#SurCharge#</div></td>
      <td><div align="center"><a href = "doshipping.cfm?action=DeleteSurCharge&ChargeID=#ChargeID#">Delete</a></div></td>
    </tr>
  </cfoutput> 
</table>
