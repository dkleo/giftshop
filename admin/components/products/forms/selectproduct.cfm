...
<script language="JavaScript">
 function EditItem(itemid){
		window.location.href = 'selectproduct.cfm?action=editoptions&ItemID=' + itemid;
 }
...
function selectitem( fileUrl, fname, ffield )
{
...
<cfinclude template = "../queries/qrycatalogoptions.cfm">
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td colspan="4" nowrap><span class="style2">Select An Item</span></td>
  </tr>
  <tr>
    <td colspan="4" nowrap>Select the item that this option represents. For products to be assigned to an option value for tracking inventory, you must set the product to be treated as an option in the product's settings.</td>
  </tr>
  <tr> 
    <td width="30%" nowrap> <form method="POST" action="selectproduct.cfm">
	<select name="Sortproducts">
	    ...
	    <td width="30%"> <div align="center"> <cfoutput> 
          ...
          <cfif disp LT qryCatalog.RecordCount + 1>
            <form name = "PageSelect" method="Post" Action="selectproduct.cfm">
              <select name="start" OnChange="this.form.submit();">
                <cfset PageCount = 1>
                <cfloop Index="Pages" FROM="1" TO="#qryCatalog.RecordCount#" Step="#disp#"><a href = "selectproduct.cfm?start=#Pages#">
    ...
    <td width="30%"><form name="Displayoptions" method="POST" Action="selectproduct.cfm">
    ...
    <td width="30%" nowrap> <form name="form1" method="post" action="selectproduct.cfm">
        <div align="right"> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr bgcolor="#3366CC"> 
    ...
    <td width="10%"><span class="style3">Item ID</span></td>
    <td> <strong><a href="selectproduct.cfm?OrderBy=ProductName"><font color="#FFFFFF">Name</font></a></strong></td>
  ...
  <cfloop query = "qryCatalog" startRow="#Start#" endrow="#End#"> 
    ...
    <tr class="selecttr" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'"> 
      ...
      WHERE itemid = #qryCatalog.itemid#
       ...
       <td onclick="EditItem(#qryCatalog.itemid#);"> 
         #qryCatalog.sku#      </td>
       <td>#qryCatalog.itemid#</td>
       <td><a href = "##" onclick="selectitem('#itemid#', '#fname#', '#ffield#');">#qryCatalog.ProductName#</a></td>
	...
	<tr>
	  ...
	  <td colspan="6" bgcolor="#FFFFFF" height="5">Expand/Collapse subitems</td>
    </tr>
      <td></td>
	  <td colspan="6">
