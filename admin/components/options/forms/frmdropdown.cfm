...
<cfif ISDEFINED('url.NewDropDown')>
...
<td>
  ...
  <div align="center">
      <p align="left"><strong><font size="4">Drop Down Box Builder:</font></strong></p>
        ...
        <tr>
		  ...
		  <cfoutput>
            <table border="0" width="100%">
              ...
              <tr> 
                <td colspan="2"> <input type="hidden" name="action" value="AddOption"> 
                  <p align="center"> 
...
<cfif NOT ListLen(TempVar.OptionNames) IS 0>
  ...
  <p align="center"> 
    <input type="hidden" value="UpdateListItems" name="Action">
	<cfif ISDEFINED('url.itemid')><cfoutput><input type="hidden" name = "itemid" value="#url.Itemid#" /></cfoutput></cfif>
...
<cfif NOT CaptionError IS ''>
  ...
  <p align="center">You can make this drop down a listbox by setting the height 
    greater than zero<br>
    Height of List: 
    <cfoutput><input name="OptionSize" type="text" id="OptionSize" value="#AddSize#" size="5"></cfoutput>
    <br>
    <input type="hidden" value="AddDropdown" name="Action">
    <cfif NOT ListLen(TempVar.OptionNames) IS 0>
      <cfif TempVar.IsEditing IS 'No'>
        ...
        <input type="submit" value="Create Option Drop Down" name="B1">
      </cfif>
      <cfif TempVar.IsEditing IS 'Yes'>
        ...
        <input type="submit" value="Update Option Drop Down" name="B1">
      </cfif>
    </cfif>
  </p>
</form>
