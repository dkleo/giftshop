...
<cfif #form.Caption# IS ''>
	...
	<cflocation url = "dooptions.cfm?Action=AddRadioList&CaptionError=#ErrorMessage#">
</cfif>
...
VALUES
(#NextOrderNumber#, '#form.caption#', 'RadioList', '#form.DefaultValue#', '#TempVar.OptionNames#', '#TempVar.OptionPrices#', '#TempVar.OptionWeights#', '#TempVar.OptionItemIDs#', '#form.OptionSize#', '#form.cartcaption#')</cfquery>
...
<CFSET ThisOptionWeight = #ListGetAt(TempVar.OptionWeights, LoopCount, "^")#>
	<cfif NOT ThisOptionName IS #form.DefaultValue#>
		<cfset MyOptions =  #MyOptions# & '<Input type="radio" Name="ffield#ThisFieldName#" value="#LoopCount#">#ThisOptionName#<br>'>
	</cfif>
	<cfif ThisOptionName IS #form.DefaultValue#>
		<cfset MyOptions =  #MyOptions# & '<Input type="radio" Name="ffield#ThisFieldName#" value="#LoopCount#" checked="checked">#ThisOptionName#<br>'>
	</cfif>

</cfloop>
<cfset MyOptionCode = '#MyOptions#'>
...
<cfif #form.Caption# IS ''>
	<cfset ErrorMessage = "ERROR:  Please enter a caption for this drop down box!"> 
	<cflocation url = "dooptions.cfm?Action=AddRadioList&CaptionErrorLine=#ErrorLine#">
</cfif>
