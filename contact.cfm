...
<cfscript>
    personalInfo = {name = 'Derek Lords', address = '3316 SE 118th Avenue<br />Portland, OR 97266', phonenumber = '(917) 579-2367', email = 'dkleo@me.com', skype = 'derek.lords'};
</cfscript>
...
<head>
  ...
  <cfoutput><title>CONTACT | #application.seoPageTitle#</title></cfoutput>
...
<cfif form.submitted>
    ...
    <cfif !ok>
        <p>You did not provide all of the required information!</p>
    <cfelse>
...
<cfoutput>
  <div class="clr">
    <div class="input-box1">Address</div><span>#personalInfo['address']#</span></div>
  <div class="clr"> &nbsp;</div>
<div class="clr">
  <div class="input-box1">Phone</div><span>#personalInfo['phonenumber']#</span></div>
<div class="clr">
  <div class="input-box1">E-mail</div><span><a href="##">#personalInfo['email']#</a></span>  </div>
<div class="clr">
  <div class="input-box1">Skype</div> <span><a href="##">#personalInfo['skype']#</a></span> </div>
</cfoutput>
</div>
  <div class="clr">
